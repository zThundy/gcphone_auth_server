...
class RoomButtonHandler {
    constructor(client, currentServer, roomManager, tokenManager, config) {
        ...
        this.config = config;
        this.language = this.config.language.buttonRooms;
                ...
                button.reply({
                    embeds: [
                        this.utils.getEmbedMessage({
                            colorHex: "#c91212",
                            title: this.language["BUTTON_TITLE"],
                            description: this.language["BUTTON_PRESS_ERROR_1"],
                            timestamp: true,
                            thumbnail: this.language["BUTTON_PRESS_ERROR_THUMBNAIL_1"]
                        })
                    ],
                    ephemeral: true
                }).catch(console.error);
                ...
                button.reply({
                    embeds: [
                        this.utils.getEmbedMessage({
                            colorHex: "#c91212",
                            title: this.language["BUTTON_TITLE"],
                            description: this.language["BUTTON_PRESS_ERROR_2"],
                            timestamp: true,
                            thumbnail: this.language["BUTTON_PRESS_ERROR_THUMBNAIL_2"]
                        })
                    ],
                    ephemeral: true
                });
            ...
            button.reply({
                embeds: [
                    this.utils.getEmbedMessage({
                        colorHex: "#c91212",
                        title: this.language["BUTTON_TITLE"],
                        description: this.language["BUTTON_PRESS_SUCCESS"],
                        timestamp: true,
                        thumbnail: this.language["BUTOON_PRESS_SUCCESS_THUMBNAIL"]
                    })
                ],
                ephemeral: true
            }).catch(console.error);
